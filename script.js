...
function printListItem(value) {
  ...
  let spanListElm = document.createElement("span");
  console.log(value);

  // spanListElm.appendChild(inputValue);
  btnListElm.appendChild(spanListElm);
  toDoListContainer.appendChild(btnListElm);
}
